...
def save_ripe_location_output(ripe_location, ip_version = 4, tags='default'):
	...
	with open('stats/location_data/ripe_location_output_v{}_{}'.format(ip_version, tags), 'wb') as fp:
		pickle.dump(ripe_location, fp)


def get_ripe_ip_to_location_map():

	ripe_ipmap_files_path = 'stats/location_data/ripe_ipmap_files'
...
def load_ripe_geolocation_output (ip_version=4, tags='default', ips_list=[]):
	...
	file_location = 'stats/location_data/ripe_location_output_v{}_{}'.format(ip_version, tags)
